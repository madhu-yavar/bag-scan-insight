...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "BagScan — AI baggage inspection from 4 photos" },
      ...
      { property: "og:title", content: "BagScan — AI baggage inspection" },
      { property: "og:description", content: "Snap 4 photos, get instant AI-powered baggage metadata: dimensions, color, damage, wheels and more." },
